...
import { useCountdown } from '@/features/projects/features/duck-feed/hooks/use-countdown';
import type {
  BoardSize,
  Difficulty,
  FeedItem,
...
} from '@/features/projects/features/duck-feed/utils/geometry';
import {
  ...
  POPUP_LIFETIME_MS,
  randomDelayMs,
} from '@/features/projects/features/duck-feed/utils/scoring';
